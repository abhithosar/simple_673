...
10. For evaluation scripts use following repository
    https://github.com/abhithosar/chartocr_cv

11. For model created on CornerNet use following repository
    https://github.com/abhithosar/simple_673

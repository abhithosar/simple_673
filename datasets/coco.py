...
import lib.cocoapi.PythonAPI.pycocotools.coco as coco
#import pycocotools.coco as coco
from lib.cocoapi.PythonAPI.pycocotools.cocoeval import COCOeval
...
class COCO(Dataset):
  def __init__(self, data_dir, split, split_ratio=1.0, gaussian=True, img_size=511):
    ...
    self.images = self.coco.getImgIds()[:10]
